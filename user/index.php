                ...
                <div class="row">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" class="needs-validation" name="save" novalidate="" autocomplete="off" enctype="multipart/form-data">
                            ...
                            <div class="row uploadDoc">
                                ...
                                <div class="col-sm-12 mt-4">
                                    ...
                                    <div class="fileUpload btn btn-orange">
                                        <img src="https://www.kindpng.com/picc/m/261-2619141_cage-clipart-victorian-cloud-upload-icon-svg-hd.png" class="icon">
